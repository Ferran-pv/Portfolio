...
if __name__ == '__main__':
    ...
    classifier_pipe = Pipeline([('vectorizer', TfidfVectorizer()), ('classifier', LogisticRegression())])
    ...
    # save and load model
    text_classifier = TextClassifier(classes=X_test['target_names'],pipeline=classifier_pipe)
    text_classifier.save('tmp/classifier.pkl') # ! amb / inici no funciona. Sense folder tmpoc.
